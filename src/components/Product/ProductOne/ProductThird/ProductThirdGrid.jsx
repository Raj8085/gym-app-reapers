...
// //     );
// //   }
// // export default ProductThirdGrid;
...
//     // Color filter (assuming colors array contains color names)
//     if (filters.colors.length > 0) {
//       // You might need to adjust this based on how your colors are stored
//       const productColors = product.colors.map(c => {
//         // Extract color name from URL or use a mapping
//         return c.split('/').pop().split('-')[0];
//       });
